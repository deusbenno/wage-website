...
<!-- FOOTER COMPONENT -->
<footer id="contact" class="bg-gradient-to-b from-[#061e12] to-[#031009] text-white/90 px-5 pt-16 pb-8 lg:px-8">
    <div class="mx-auto max-w-7xl grid gap-10 sm:grid-cols-2 lg:grid-cols-4 pb-12 border-b border-white/10">
        
        <!-- Brand / About Block -->
        <div class="space-y-4">
            <div class="flex items-center gap-3">
                <span class="grid h-10 w-10 place-items-center rounded-full border border-[#d2e829]/40 text-[#d2e829]">
                    <svg class="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path d="M7 20c0-8 4-13 12-15-.4 8-5 12-12 12"/>
                        <path d="M7 20c0-5-2-8-6-10 5-.4 8 2 9 6"/>
                    </svg>
                ...
                <span class="leading-none">
                    <span class="block text-2xl font-black tracking-wide text-white">WAGE</span>
                    <span class="block text-[10px] font-bold uppercase tracking-[0.15em] text-white/60">Solutions Limited</span>
                </span>
            </div>
            <p class="text-sm leading-6 text-white/70">
                Premium product processing, local sourcing, aggregation, and strategic international market link services.
            </p>
        </div>

        <!-- Quick Links Block -->
        <div>
            <h4 class="text-sm font-black uppercase tracking-wider text-[#d2e829] mb-4">Quick Links</h4>
            <ul class="space-y-2.5 text-sm font-semibold">
                <li><a href="#" class="hover:text-[#d2e829] transition">Home</a></li>
                <li><a href="#about" class="hover:text-[#d2e829] transition">About Us</a></li>
                <li><a href="#products" class="hover:text-[#d2e829] transition">Our Products</a></li>
                <li><a href="#services" class="hover:text-[#d2e829] transition">Services</a></li>
            </ul>
        </div>

        <!-- Product Verticals -->
        <div>
            <h4 class="text-sm font-black uppercase tracking-wider text-[#d2e829] mb-4">Core Produce</h4>
            <ul class="space-y-2.5 text-sm text-white/80">
                <li>Fresh Avocados</li>
                <li>Maize Premium Flour</li>
                <li>Ginger &amp; Turmeric</li>
                <li>Cloves &amp; Exotic Spices</li>
            </ul>
        </div>

        <!-- Contact details -->
        <div>
            <h4 class="text-sm font-black uppercase tracking-wider text-[#d2e829] mb-4">Contact Channels</h4>
            <ul class="space-y-3 text-sm font-semibold">
                <li class="flex items-start gap-3">
                    <svg class="h-5 w-5 text-[#d2e829] mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                    <span class="text-white/80 break-all">info@wagesolutions.co.tz</span>
                </li>
                <li class="flex items-start gap-3">
                    <svg class="h-5 w-5 text-[#d2e829] mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <span class="text-white/80">Dar es Salaam, Tanzania</span>
                </li>
            </ul>
        </div>
    ...
    <!-- Copyright Bar -->
    <div class="mx-auto max-w-7xl pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-white/50 font-semibold">
        <p>&copy; {{ date('Y') }} WAGE Solutions Limited. All rights reserved.</p>
        <div class="flex gap-4">
            <a href="#" class="hover:text-[#d2e829]">Privacy Policy</a>
            <a href="#" class="hover:text-[#d2e829]">Terms of Service</a>
        </div>
    </div>
</footer>
